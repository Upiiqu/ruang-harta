        ...
        <div className="glass-panel" style={{ padding: 'var(--space-6)', gridColumn: '1 / -1' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }} className="flex flex-col gap-2 text-sm">
              ...
              <li className="flex gap-2"><span className="text-accent">📈</span> <b>Saran Alokasi:</b> Mendapatkan rekomendasi alokasi budget (seperti aturan 50/30/20) berdasarkan pola gaji dan pengeluaran tetap Anda.</li>
            </ul>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }} className="flex flex-col gap-2 text-sm">
              <li className="flex gap-2"><span className="text-accent">⚠️</span> <b>Peringatan Hutang:</b> Jika rasio hutang Anda membahayakan kondisi finansial, AI akan menyarankan strategi pelunasan (Debt Avalanche/Snowball).</li>
              <li className="flex gap-2"><span className="text-accent">💡</span> <b>Langkah Konkret:</b> Anda tidak hanya diberi grafik, tapi juga 3-5 poin saran *actionable* yang bisa langsung diterapkan besok pagi.</li>
            </ul>
          </div>
        </div>
      </div>
